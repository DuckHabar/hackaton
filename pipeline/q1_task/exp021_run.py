"""
EXP-021: cross-NWP disagreement features поверх EXP-020 setup.
...
EXP_DIR = ROOT / "experiments/active/EXP-021"
...
def main():
    t0 = time.time()
    print("[EXP-021] prepare features ...")
    ...
    print(f"[EXP-021] features: {len(final_cols)} (sister={len(sister_cols)}, dis={len(dis_cols)})")
    ...
    print(f"\n[EXP-021] CV = {cv_mean:.4f}% +/- {cv_std:.4f}% Q1={cv_q1:.4f}%")
    ...
    summary = {
        "exp_id": "EXP-021", "name": "sister_5src_plus_disagreement",
