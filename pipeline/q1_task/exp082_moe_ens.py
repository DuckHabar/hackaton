"""
EXP-082: Optuna ensemble {EXP-019, EXP-020, EXP-021, EXP-024, EXP-081}
с 3yr conformal cal per base (same as EXP-054 paradigm).

EXP-081 (MoE transformer) - новая база. CV 8.2086 - best single base.
EXP-054 winner - Optuna weights над 4 cal'd bases (019/020/021/024). 0.74 weight на EXP-021.

Hypothesis: adding spatial diversity -> better blend. Expected LB win если EXP-081 OOF orthogonal to others.
...
EXP_DIR = ROOT / "experiments/active/EXP-082"
...
def main():
    ...
    bases = ["EXP-019", "EXP-020", "EXP-021", "EXP-024", "EXP-081"]
    oofs_cal = {}
    valids_cal = {}
    for b in bases:
        print(f"Loading {b} ...")
